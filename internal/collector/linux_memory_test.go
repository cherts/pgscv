...
func TestMeminfoCollector_Update(t *testing.T) {
	...
	var input = pipelineInput{
		...
		optional: []string{
			...
			"node_vmstat_swpin_zero", "node_vmstat_nr_memmap_boot_pages", "node_vmstat_zone_reclaim_success",
			"node_vmstat_thp_underused_split_page", "node_vmstat_nr_hugetlb", "node_vmstat_swpout_zero",
			"node_vmstat_nr_memmap_pages",
		},
