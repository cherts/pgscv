...
PG_DATADIR=${1:-"/data/postgres"}
PG_HOST=${2:-"postgres"}
PG_PORT=${3:-"5432"}
PG_REPLUSER=${3:-"repluser"}
PG_REPLUSER_PASSWORD=${4:-"repluser"}
PG_REPL_SLOT=${5:-"replica_slot1"}
...
su - postgres -c "PGDATA=${PG_DATADIR} postgres ${PG_OPTS} ${PG_EXTRA_OPTS}"
